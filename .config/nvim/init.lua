require "paq" {
    ...
    "simrat39/symbols-outline.nvim", "ruifm/gitlinker.nvim", "tanvirtin/vgit.nvim", "tpope/vim-endwise", "kdheepak/lazygit.nvim",
...
augroup extension_syntax_setting
  ...
  autocmd BufNewFile,BufRead *.env,*.local,*.uat,*.prod,*.envrc,*.in set syntax=zsh
augroup end
]], false)
